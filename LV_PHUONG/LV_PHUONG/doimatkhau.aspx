<%@ Page Title="" Language="C#" MasterPageFile="~/Master Page.Master" AutoEventWireup="true" CodeBehind="doimatkhau.aspx.cs" Inherits="LV_PHUONG.doimatkhau" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
     ...
     <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default panel-border-color panel-border-color-primary">
                <div class="panel-heading panel-heading-divider" style="font-size: 16px; font-weight: bold; color: black"> THAY ĐỔI MẬT KHẨU ĐĂNG NHẬP</div>
                <div class="panel-body">
                    <div class="form-horizontal group-border-dashed">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                               <asp:TextBox ID="txttk" class="form-control input-sm" runat="server" Width="100%" ReadOnly="True" CausesValidation="True"></asp:TextBox>
                            </div>
                        </div>
                          <div class="form-group">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <label class="col-sm-3 control-label">Nhập lại mật mới</label>
                            <div class="col-sm-6">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString='<%$ ConnectionStrings:connString %>' SelectCommand="CANBO_SELECT_ALL" SelectCommandType="StoredProcedure" UpdateCommand="LOGIN_DOIMATKHAU" UpdateCommandType="StoredProcedure">
        <UpdateParameters>
            <asp:ControlParameter ControlID="txtnhaplaimk" Name="DN_PASSWORD" PropertyName="Text" Type="String" />
