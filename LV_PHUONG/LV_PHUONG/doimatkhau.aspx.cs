...
namespace LV_PHUONG
{
    public partial class doimatkhau : System.Web.UI.Page
    {
        ...
        {
            txttk.Text = Convert.ToString(Session["user"]);
        }

        protected void btnluu_Click(object sender, EventArgs e)
        {
            DataTable dtResult = new DataTable();
            SqlParameter user = new SqlParameter("@CB_MA", txttk.Text);
            SqlParameter pass = new SqlParameter("@DN_PASSWORD", txtmkht.Text);
